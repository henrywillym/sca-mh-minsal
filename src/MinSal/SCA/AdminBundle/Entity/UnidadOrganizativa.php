...
/**
 * MinSal\SCA\AdminBundle\Entity\UnidadOrganizativa
 *
 * @ORM\Table(name="sca_unidadorganizativa")
 * @ORM\Entity
 */
class UnidadOrganizativa {
     ...
     * Add subUnidades
     *
     * @param MinSal\SCA\AdminBundle\Entity\UnidadOrganizativa $subUnidades
     */
    public function addUnidadOrganizativa(\MinSal\SCA\AdminBundle\Entity\UnidadOrganizativa $subUnidades) {
