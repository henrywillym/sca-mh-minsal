...
use MinSal\SCA\AdminBundle\Form\Type\OpcionSistemaType;
...
class AccionAdminOpcionesController extends Controller {
    ...
    public function nuevaOpcAction() {
        ...
        $form = $this->createForm(new OpcionSistemaType(), $opc);
        return $this->render('MinSalSCAAdminBundle:Default:opcionFormTemplate.html.twig', array('form' => $form->createView(), 'opciones' => $opciones));
    }
    ...
    public function mattOpcionesAction() {
        ...
        return $this->render('MinSalSCAAdminBundle:Opciones:manttOpcionesSystemForm.html.twig', array('opciones' => $opciones, 'opcsistem' => $opcionesSistema));
    }
