...
/* MinSalSidPlaPaoBundle:PeriodoPaoOficial:showPeriodoOficial.html.twig */
class __TwigTemplate_015bc11b3967ba2debe5a724b6f2727e extends Twig_Template
{
    ...
    myGrid.jqGrid({ 
      ...
      colModel:[
        ...
        { name:'nombre', index: 'nombre', width:150,editable:true,editoptions:{size:30},edittype:\"select\",
                        editoptions: {value:\"0:Seleccione un Tipo de Periodo;";
        // line 38
        echo twig_escape_filter($this->env, $this->getContext($context, 'combotipoperiodos'), "html");
        echo "\"},editrules:{custom:true, custom_func:validaTipoPeriodo}
        },//Fin del nombre
...
";
    ...
    {
        return "MinSalSidPlaPaoBundle:PeriodoPaoOficial:showPeriodoOficial.html.twig";
    }
