...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // MinSalSidPlaDependenciaBundle_homepage
        if ($pathinfo === '/SidPla/Dependencia') {
            return array (  '_controller' => 'MinSal\\SidPla\\DependenciaBundle\\Controller\\DefaultController::indexAction',  '_route' => 'MinSalSidPlaDependenciaBundle_homepage',);
        }
