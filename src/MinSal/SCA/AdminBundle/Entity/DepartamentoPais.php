...
/**
 * MinSal\SCA\AdminBundle\Entity\DepartamentoPais
 *
 * @ORM\Table(name="sca_departamento")
 * @ORM\Entity
 */
class DepartamentoPais
{
     ...
     * Add municipios
     *
     * @param MinSal\SCA\AdminBundle\Entity\Municipio $municipios
     */
    public function addMunicipios(\MinSal\SCA\AdminBundle\Entity\Municipio $municipios)
    {
     ...
     * @param MinSal\SCA\AdminBundle\Entity\Municipio $municipios
     */
    public function addMunicipio(\MinSal\SCA\AdminBundle\Entity\Municipio $municipios)
    {
        $this->municipios[] = $municipios;
    }
}