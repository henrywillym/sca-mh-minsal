...
class InventarioDet {
     ...
     * @ORM\ManyToOne(targetEntity="MinSal\SidPla\AdminBundle\Entity\Cuota")
     * @ORM\JoinColumn(name="cuo_id", referencedColumnName="cuo_id")
     */
    protected $cuota;
    
    /**
     * @ORM\ManyToOne(targetEntity="MinSal\SidPla\SCAProcesosBundle\Entity\Inventario", inversedBy="inventariosDet", cascade={"persist"})
     ...
     * @ORM\OneToOne(targetEntity="MinSal\SidPla\SCAProcesosBundle\Entity\InventarioDet")
    ...
    /**
     * Es Many-To-One, Unidirectional
     * @ORM\ManyToOne(targetEntity="MinSal\SidPla\AdminBundle\Entity\Entidad")
     * @ORM\JoinColumn(name="ent_id", referencedColumnName="ent_id")
     */
    protected $entidad;
    
    /**
     * ORM\ManyToOne(targetEntity="MinSal\SidPla\SCAProcesosBundle\Entity\SolicitudImportacion", inversedBy="inventariosDet")
     * ORM\JoinColumn(name="alc_id", referencedColumnName="alc_id")
     */
    protected $solImportacion;
    
    /**
     * ORM\ManyToOne(targetEntity="MinSal\SidPla\SCAProcesosBundle\Entity\SolicitudLocal", inversedBy="inventariosDet")
     * ORM\JoinColumn(name="alc_id", referencedColumnName="alc_id")
     */
    protected $solLocal;
