...
use MinSal\SCA\AdminBundle\Form\Type\RolSistemaType;
...
class AccionAdminRolesController extends Controller {
    ...
    public function addRolAction(Request $peticion) {
        ...
        return $this->redirect($this->generateUrl('MinSalSCAAdminBundle_homepage'));
    }
    ...
    public function nuevoRolAction() {
        ...
        $form = $this->createForm(new RolSistemaType(), $rol);
        return $this->render('MinSalSCAAdminBundle:Default:rolFormTemplate.html.twig', array('form' => $form->createView(), 'opciones' => $opciones));
    }
    ...
    public function consultarRolesAction() {
        ...
        /* return $this->render('MinSalSCAAdminBundle:Roles:showAllRoles.html.twig', 
    ...
    public function asignarOpcRolesAction() {
        ...
        return $this->render('MinSalSCAAdminBundle:Roles:asignarOpcionesARoles.html.twig', array('opciones' => $opciones,));
    }
