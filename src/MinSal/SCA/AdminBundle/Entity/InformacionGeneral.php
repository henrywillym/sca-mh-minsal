...
/**
 * MinSal\SCA\AdminBundle\Entity\InformacionGeneral
 *
 * @ORM\Table(name="sca_informaciongeneral")
 * @ORM\Entity
 */
class InformacionGeneral
{
     ...
     *
     * @param MinSal\SCA\AdminBundle\Entity\UnidadOrganizativa $unidadOrganizativa
     */
    public function setUnidadOrganizativa(\MinSal\SCA\AdminBundle\Entity\UnidadOrganizativa $unidadOrganizativa)
    {
     ...
     *
     * @return MinSal\SCA\AdminBundle\Entity\UnidadOrganizativa 
     */
