...
class __TwigTemplate_36f9410c97673b18bc7ff6ea3beb29ee extends Twig_Template
{
...
<HTML>
    ...
    ";
        ...
        if ($this->env->getExtension('security')->isGranted("IS_AUTHENTICATED_REMEMBERED")) {
            ...
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, 'app'), "user", array(), "any", false), "empleado", array(), "any", false), "primerNombre", array(), "any", false), "html");
            echo "&nbsp;";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, 'app'), "user", array(), "any", false), "empleado", array(), "any", false), "primerApellido", array(), "any", false), "html");
            echo "!!</h3>                            
                        <h3 align=\"right\">";
            // line 83
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, 'app'), "user", array(), "any", false), "empleado", array(), "any", false), "unidadOrganizativa", array(), "any", false), "nombreUnidad", array(), "any", false), "html");
            echo "</h3>                         
                            ";
        }
        // line 84
