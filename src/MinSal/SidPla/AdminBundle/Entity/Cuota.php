...
class Cuota {
    ...
    /**
     * @ORM\ManyToOne(targetEntity="MinSal\SidPla\AdminBundle\Entity\Alcohol", inversedBy="cuotas")
     * @ORM\JoinColumn(name="alc_id", referencedColumnName="alc_id")
     */
    protected $alcohol;
    
    /**
     * @ORM\ManyToOne(targetEntity="MinSal\SidPla\AdminBundle\Entity\Entidad", inversedBy="cuotas")
