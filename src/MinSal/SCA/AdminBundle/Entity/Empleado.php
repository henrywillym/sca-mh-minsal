...
/**
 * MinSal\SCA\AdminBundle\Entity\Empleado
 *
...
/**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="MinSal\SCA\AdminBundle\Entity\Entidad", inversedBy="users")
     * @ORM\JoinColumn(name="ent_id", referencedColumnName="ent_id")
     */
    protected $entidad;

    /**
     * ORM\ManyToOne(targetEntity="MinSal\SCA\AdminBundle\Entity\RolSistema", inversedBy="usuarios")
     ...
     * Set empleado
     *
     * @param MinSal\SCA\UsersBundle\Entity\Empleado $empleado
     */
    /*public function setEmpleado(\MinSal\SCA\AdminBundle\Entity\Empleado $empleado) {
     ...
     * Get empleado
     *
     * @return MinSal\SCA\UsersBundle\Entity\Empleado 
     */
