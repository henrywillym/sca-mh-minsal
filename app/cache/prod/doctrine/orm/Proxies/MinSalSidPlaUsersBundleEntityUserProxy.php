 ...
 */
class MinSalSidPlaUsersBundleEntityUserProxy extends \MinSal\SidPla\UsersBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'algorithm', 'salt', 'password', 'lastLogin', 'locked', 'expired', 'expiresAt', 'confirmationToken', 'passwordRequestedAt', 'roles', 'credentialsExpired', 'credentialsExpireAt', 'idUsuario', 'empleado', 'rol', 'idEmpleado');
    }
