<?php
// src/MinSal/SCA/AdminBundle/Entity/Alcohol.php
...
use MinSal\SCA\AdminBundle\Entity\GrupoAlcohol;
...
class Alcohol {
    ...
    /**
     * @ORM\OneToMany(targetEntity="MinSal\SCA\AdminBundle\Entity\Cuota", mappedBy="alcohol")
     */
    protected $cuotas;
    
    /**
     * @ORM\ManyToOne(targetEntity="MinSal\SCA\AdminBundle\Entity\GrupoAlcohol", inversedBy="alcoholes")
