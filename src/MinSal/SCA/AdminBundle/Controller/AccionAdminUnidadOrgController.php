...
use MinSal\SCA\AdminBundle\EntityDao\UnidadOrganizativaDao;
use MinSal\SCA\AdminBundle\EntityDao\DepartametoPaisDao;
use MinSal\SCA\AdminBundle\Entity\UnidadOrganizativa;
use MinSal\SCA\AdminBundle\Entity\Municipio;
use MinSal\SCA\AdminBundle\Entity\DepartamentoPais;
...
class AccionAdminUnidadOrgController extends Controller {
    ...
    public function consultarUnidadesOrgAction() {
        ...
        return $this->render('MinSalSCAAdminBundle:UnidadOrganizativa:showAllUnidadesOrganizativas.html.twig'
    ...
    public function ingresoNuevaUnidadesOrgAction() {
        ...
        return $this->render('MinSalSCAAdminBundle:UnidadOrganizativa:ingresoUnidadOrganizativa.html.twig', array('opciones' => $opciones, 'deptos' => $departamentos));
    }
    ...
    public function ingresarUnidadOrgAction() {
        ...
        return $this->render('MinSalSCAAdminBundle:UnidadOrganizativa:manttUnidadesOrganizativas.html.twig', array('opciones' => $opciones,));
    }
    ...
    public function editarUnidadesOrgAction() {
       ...
       // $idinfogeneral = $uni->getInformacionGeneral()->getIdInformacionGeneral();
        ...
        return $this->render('MinSalSCAAdminBundle:UnidadOrganizativa:EditarUnidadOrganizativa.html.twig', array('opciones' => $opciones
