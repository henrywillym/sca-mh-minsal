...
class __TwigTemplate_0d972ccb0e3413cbe8785dd70453203c extends Twig_Template
{
      ...
      \$('#tabElemInfra').jqGrid({ 
          ...
          colModel:[
            ...
            { name:'abreunidmed', index: 'abreunidmed', width:150,editable:true,editoptions:{size:30},edittype:\"select\",align:\"center\",
                        editoptions: {value:\"";
        // line 25
        echo twig_escape_filter($this->env, $this->getContext($context, 'comboUniMed'), "html");
        echo "\"},editrules:{custom:true, custom_func:validaUnidad}
            },//Fin del nombre
...
\$(\"#reporte\").click(function(){
  ...
  //fin
   ...
   <div id=\"pager1\" class=\"scroll\"></div>  
    ...
    <br></br>
    <form id=\"formInfraEstructura\" action=\"";
        // line 110
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("MinSalSidPlaReportesBundle_reporteElementoInfra"), "html");
        echo "\" method=\"post\" >
...
";
    ...
    {
        return "MinSalSidPlaEstInfraBundle:ElementoInfraestructura:showElementoInfraestructura.html.twig";
    }
