...
use MinSal\SCA\AdminBundle\EntityDao\MensajeCorreTempDao;
use MinSal\SCA\AdminBundle\Entity\MensajeCorreTemp;
...
class AccionAdminMenCorreTempController extends Controller {
    ...
    public function consultarMenCorrtempAction() {
        ...
        return $this->render('MinSalSCAAdminBundle:MensajeCorreoTemplate:manttMensajesCorreoTemForm.html.twig'
