...
class AccionAdminListadoDNMController extends Controller {
 ...
 /*   public function nuevaOpcAction() {
        ...
        $form = $this->createForm(new ListadoDNMSistemaType(), $opc);
        return $this->render('MinSalSCAAdminBundle:Default:ListadoDNMFormTemplate.html.twig', array('form' => $form->createView(), 'ListadoDNMes' => $ListadoDNMes));
    }
	*/
    ...
    public function LoadListadoDNMAction() {
        ...
        return $this->render('MinSalSCAAdminBundle:ListadoDNM:manttListadoDNMForm.html.twig', array(
            'opciones' => $opciones
        ));
    }
